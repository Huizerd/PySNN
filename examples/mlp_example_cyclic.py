...
class Network(SpikingModule):
    ...
    def forward(self, input):
        ...
        # Layer 1
        x_backward, t_backward = self.mlp2_backwards(
            self.neuron2.spikes, self.neuron2.trace
        )
        x_forward, t_forward = self.mlp1_c(x, t)
        x, t = self.neuron1([x_forward, x_backward], [t_forward, t_backward])
